...
apt install -y git php php-xml apache2 libapache2-mod-php php-cli php-mbstring python-pip terminator libxml2-dev libxslt-dev libz-dev npm nodejs gconf2
